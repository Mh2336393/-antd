...
export default {
  ...
  effects: {
    *fetchAlarmList({ payload }, { call, put }) {
      ...
      const response = yield call(apiRequest, 'event/getSafeEventList', { ...payload, category_1: '失陷感知' });
    ...
    *fetchFilterCount({ payload }, { call, put }) {
      const response = yield call(apiRequest, 'event/getSafeEventFilterCount', { ...payload, category_1: '失陷感知' });
