...
class FileBehaviorApt extends Component {
  constructor(props) {
    super(props);
    this.state = {
      showAll: false,
  ...
  componentDidMount() {
    ...
    dispatch({ type: 'aptDetail/fetchFileBehavior', payload: { md5 } });
  }
  ...
  showProcessTree = (id) => {
    const {
      aptDetail: { behaviorObj },
    } = this.props;
    const { ProcessTree } = behaviorObj;
    // const selectedArr = [];
  ...
  render() {
    ...
    const { File, Hook, Net, Other, Process, Reg } = behaviorObj;
    ...
    return (
      <div>
        {!showAll ? (
              ...
              {File.length > 5 && (
                <Button
                  ...
                  onClick={() => {
                    this.setState({
                      showAll: true,
                      allData: { theme: '文件行为', allList: behaviorObj.File },
                    });
                  }}
                >
                  查看完整行为
              ...
              {Process.length > 5 && (
                <Button
                  ...
                  onClick={() => {
                    this.setState({
                      showAll: true,
                      allData: { theme: '进程行为', allList: behaviorObj.Process },
                    });
                  }}
                >
                  查看完整行为
              ...
              {Reg.length > 5 && (
                <Button
                  ...
                  onClick={() => {
                    this.setState({
                      showAll: true,
                      allData: { theme: '注册表行为', allList: behaviorObj.Reg },
                    });
                  }}
                >
                  查看完整行为
              ...
              {Net.length > 5 && (
                <Button
                  ...
                  onClick={() => {
                    this.setState({
                      showAll: true,
                      allData: { theme: '网络行为', allList: behaviorObj.Net },
                    });
                  }}
                >
                  查看完整行为
              ...
              {Hook.length > 5 && (
                <Button
                  ...
                  onClick={() => {
                    this.setState({
                      showAll: true,
                      allData: { theme: 'Hook行为', allList: behaviorObj.Hook },
                    });
                  }}
                >
                  查看完整行为
              ...
              {Other.length > 5 && (
                <Button
                  ...
                  onClick={() => {
                    this.setState({
                      showAll: true,
                      allData: { theme: '其他行为', allList: behaviorObj.Other },
                    });
                  }}
                >
                  查看完整行为
          ...
          <div className={styles.actionAllWrap}>
            <div>
              <a
                onClick={() => {
...
export default connect(({ aptDetail, loading }) => ({
  aptDetail,
  loading: loading.effects['aptDetail/fetchFileBehavior'],
}))(FileBehaviorApt);
